...
public class PrimaryTest {
    ...
    public static void main(String[] args) {
        ...
        HyperMessageBroker broker1 = new HyperMessageBroker("localhost", 25365, scheduler);
        HyperMessageBroker broker2 = new HyperMessageBroker("localhost", 25365, scheduler);
